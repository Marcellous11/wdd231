...
const createDisplayElement = (course) =>{
    let courseDisplay = document.createElement("div")
    courseDisplay.innerHTML  = course.title
    courseDisplay.classList.add("displayCourse")

    if(course.completed){
        courseDisplay.classList.add("completed")
    }
    return courseDisplay
}

const setDisplay = (courses) =>{
    courseContainer.innerHTML = ''
    courses.forEach((course)=>{
        let courseDisplay =createDisplayElement(course)
        courseContainer.appendChild(courseDisplay)
        })
